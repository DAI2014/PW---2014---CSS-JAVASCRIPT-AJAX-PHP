<meta content="initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport"/>
    ...
    <title id='Description'>jQWidgets Basic Calendar Mobile Example
    </title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var theme = prepareSimulator("calendar");
            $("#calendar").jqxCalendar({ titleHeight: 40, columnHeaderHeight: 40, width: '100%', height: '60%', theme: theme });
            
            $("#events").jqxListBox({ itemHeight: 34, width: '100%', height: '40%', theme: theme, source: [{ html: "12:00 <strong>Appointment with Nancy</strong>" }, { html: "16:00 <strong>Appointment with Peter</strong>" }, { html: "18:00 <strong>Fitness</strong>" }, { html: "20:00 <strong>Conference call with Alex</strong>" }] });
            initSimulator("calendar");
        });
    </script>
</head>
<body>
