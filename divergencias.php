...
?>
	...
	<legend> Divergencias de Totais Diferentes </legend>
    ...
    <tr>
        ...
        <?php
									$resultado = verifica_divergencias();
...
<legend> Divergencias de Faturas não inseridas por Comerciantes </legend>
	<table style="empty-cells:hide;" border="1" class="table" cellpadding="1" cellspacing="1">
    ...
    <tr>
        ...
        <?php
									$resultado = verifica_divergencias_nao_inseridas();
									while($row = mysql_fetch_array($resultado, MYSQL_NUM)){
									?>
									<form id="lista_de_faturas">
									<tr><td><?php echo $row[0] ?></td><td><?php echo $row[1] ?></td><td><?php echo $row[2] ?></td>
